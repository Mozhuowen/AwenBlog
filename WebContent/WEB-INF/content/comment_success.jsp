...
<html>
<head>
<meta HTTP-EQUIV="REFRESH" CONTENT="3;URL=./!show?blogid=${currentrizhi.rizhiid}#comment">
...
<tr align="center" valign="middle">
	...
	<tr>
		<td style="BACKGROUND-IMAGE: url(templates/default/dot_width.gif)" height="1"></td>
	</tr>
	<tr>
	  <td height="120" align="center" nowrap><p><b>添加评论成功</b></p>
	    <p><a href="!show?blogid=${currentrizhi.rizhiid}#comment">三秒后将自动返回<br>
